...
// // Using custom module
// const sum = add(5, 10);
// console.log(`Sum from custom module: ${sum}`);

//
const dirname = path.join(__dirname, "notes.txt");
// fs.writeFileSync(dirname, "This is my notes");

console.log(fs.readFileSync(dirname, "utf-8"));
fs.appendFileSync(dirname, "\n this is me ");
